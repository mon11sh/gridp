...
\chapter{Appendix A: Indian State Parameters}
\begin{table}[H]\centering\begin{tabularx}{\textwidth}{|X|c|c|c|}\hline \textbf{State/UT} & \textbf{Base Load (MU)} & \textbf{Noise Level} & \textbf{Region} \\ \hline
\end{tabularx}\caption{Baseline configurations for synthetic India load data}\end{table}
\chapter{Appendix B: Project Source Code}
This appendix contains the complete operational source code for the GridOne framework.

\section{Source Code: \texttt{app.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=app.py]
...
\section{Source Code: \texttt{config.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=config.py]
import ssl
...
\section{Source Code: \texttt{data.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=data.py]
import pandas as pd
import numpy as np
import streamlit as st
...
\section{Source Code: \texttt{training.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=training.py]
import streamlit as st
import numpy as np
import pandas as pd
...
\section{Source Code: \texttt{forecasting.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=forecasting.py]
import numpy as np
import pandas as pd
...
\section{Source Code: \texttt{metrics.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=metrics.py]
import numpy as np
import scipy.stats
...
\section{Source Code: \texttt{tirex_utils.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=tirex_utils.py]
import pandas as pd
import numpy as np
...
\section{Source Code: \texttt{ui_india.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=ui_india.py]
import streamlit as st
import pandas as pd
import numpy as np
...
def run_india_mode(sidebar):
    ...
    if not run_btn:
        ...
        with st.expander(' About India Mode'):
            st.markdown('''
...
**Target:** Day Demand (MU  Million Units)
            ''')
        if show_national:
            st.subheader(' National Overview (Synthetic Baseline)')
    ...
    with st.spinner(f' Generating synthetic data for {state_name}'):
    ...
    if metrics_dict:
        ...
        st.subheader(' DieboldMariano Test')
    ...
    if forecast_future and future_dict:
        ...
        st.download_button(' Download Future Forecasts (CSV)',
    ...
    if show_national:
        st.subheader(' National Overview (All 37 States, Synthetic)')
        all_frames = []
    ...
    st.download_button(' Download Test Results (CSV)', res_df.to_csv(),
                       f'India_{state_name}_test_{datetime.now():%Y%m%d}.csv', 'text/csv')

\end{lstlisting}

\section{Source Code: \texttt{ui_us.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=ui_us.py]
import streamlit as st
import pandas as pd
import numpy as np
from datetime import datetime, timedelta
...
def run_us_mode(sidebar):
    with sidebar:
        ...
        if days_diff < 30: st.warning(' Select at least 30 days')
        st.subheader('Models')
...
\section{Source Code: \texttt{visualization.py}}
\begin{lstlisting}[language=Python, breaklines=true, basicstyle=\ttfamily\scriptsize, caption=visualization.py]
import plotly.graph_objects as go
